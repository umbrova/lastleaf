...
export function TabRow({ tab, defaultOpen = false, onAction }: Props) {
  ...
  if (actioned) {
    return (
      <div style={{
        padding: "7px 0", borderBottom: "0.5px solid #F0EDE6",
        fontSize: "11px",
        color: actioned === "rescued" ? "#1D9E75" : "#888780",
  ...
  return (
    <div style={{ borderBottom: "0.5px solid #F0EDE6" }}>
      <div
        onClick={() => setOpen(v => !v)}
        style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "7px 0", gap: "6px", cursor: "pointer" }}
      >
        <div style={{ display: "flex", alignItems: "center", gap: "6px", minWidth: 0, flex: 1 }}>
          <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#B4B2A9" strokeWidth="2" strokeLinecap="round" style={{ flexShrink: 0 }}>
      ...
      {open && (
        <div style={{ paddingBottom: "8px", paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "3px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#B4B2A9" strokeWidth="2" strokeLinecap="round">
              <circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/>
              <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/>
            </svg>
            <span style={{ fontSize: "11px", color: "#888780" }}>{tab.domain}</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#B4B2A9" strokeWidth="2" strokeLinecap="round">
              <circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>
            </svg>
            <span style={{ fontSize: "11px", color: "#888780" }}>{formatTime(tab.timeSpent)} spent</span>
          </div>
          ...
          <div style={{ display: "flex", gap: "12px" }}>
            ...
            <button
              ...
              style={{ fontSize: "11px", background: "none", border: "none", padding: 0, cursor: "pointer", color: "#D85A30", textDecoration: "underline", textUnderlineOffset: "2px", fontFamily: "inherit" }}
            >
              Bury
            </button>
          </div>
